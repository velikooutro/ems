# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-05-13 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_no', models.ForeignKey(db_column='emp_no', on_delete=django.db.models.deletion.CASCADE, related_name='employeeSTitles', to='myems.Employee')),
            ],
            options={
                'db_table': 'titles',
            },
